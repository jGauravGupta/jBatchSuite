...
public class Job2Java {
    ...
    public void generateSource(ITaskSupervisor task, Project project, SourceGroup sourceGroup, Definitions definitions) {
        this.task = task;
    ...
    private void generateJobXML() {
        ...
        jobXMLGenerator.generateJobXML(task , project, sourceGroup, definitions.getName(), definitions.getJob());

    }
     private void generateJobSource() {
        JobSourceGenerator jobSourceGenerator = new JobSourceGenerator();
        jobSourceGenerator.generateSource(task , project, sourceGroup, definitions.getPackage(), definitions.getJob());
