 ...
 * the License.
 */
package org.netbeans.jbatch.modeler.source.generator.task;

import org.netbeans.api.progress.aggregate.AggregateProgressFactory;
import org.netbeans.api.progress.aggregate.ProgressContributor;
import org.netbeans.api.project.Project;
import org.netbeans.api.project.SourceGroup;
import org.netbeans.jbatch.modeler.source.generator.adaptor.ISourceCodeGenerator;
import org.netbeans.jbatch.modeler.source.generator.adaptor.ISourceCodeGeneratorFactory;
import org.netbeans.jbatch.modeler.source.generator.adaptor.SourceCodeGeneratorType;
import org.netbeans.jbatch.modeler.source.generator.adaptor.definition.InputDefinition;
import org.netbeans.jbatch.modeler.source.generator.adaptor.definition.orm.ORMInputDefiniton;
...
//            modelerFile.save();//asynchronous : causes to generate code before saving
    ...
    private void exportCode() {
        ...
        ISourceCodeGenerator sourceGenerator = sourceGeneratorFactory.getSourceGenerator(SourceCodeGeneratorType.BATCH);
