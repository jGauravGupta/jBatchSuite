...
public class JobDiagramModel extends JavaBatchDiagramModel {
    ...
    public void init(ModelerFile modelerFile) {
        Definitions definition = getDefinitionsTemplate(modelerFile);
        this.setDiagramElement(definition.getJobDiagram().get(0));
        this.setDefinitionElement(definition);
        this.setRootElement(definition.getJob());
        this.getModelerScene().setRootElementSpec(definition.getJob());
    }
    
    public Definitions getDefinitionsTemplate(ModelerFile modelerFile){
        ...
        definition.addJobDiagram(diagram);
        return definition;
    }
